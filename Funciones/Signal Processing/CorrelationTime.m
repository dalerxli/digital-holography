...
% Se ingresa una matriz con señales en sus filas y se encuentra el tiempo
% de correlación a 1/e del grado complejo de coherencia en cada una de las
% señales.
...
%%% Considerando que es G_I(tau) lo que se obtiene de hacer la correlación,
