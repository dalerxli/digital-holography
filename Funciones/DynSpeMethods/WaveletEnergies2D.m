% Hacer una DWT2 a un THSP y sacar la energía, o varianza de cada fila a
% distintas escalas.
% Dar la opción de usar una SWT2, perdiendo información de lo que pasa en
% los bordes.


% Creo que puede llegar a convenir tomar tiempos más cortos para el
% análisis. A lo mejor se puedan usar varias estimaciones de la actividad
% para usar más muestras.
...
for k_col = 1:resol(2)
    ...
    % Para cada escala se calcula la energía y se ubica donde corresponde
